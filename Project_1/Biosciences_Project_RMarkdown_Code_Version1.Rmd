...
print(summarized_data) #these results were used in the table s1 of the publication
```
...
# Print the period totals and percentages
print(period_totals) #these results were used in the table s1 of the publication
```
...
#these results were used in the table s1 of the publication
```
...
# Save the plot
ggsave("Figure_1.png", Figure_1, width = 10, height = 8, dpi = 300, bg="white")
```
...
Figure_s1_1 <- ggplot(summarized_data, aes(x = Type, y = Percentage, fill = as.factor(Complete))) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_manual(values = c("#D0A136", "#36D0A1","#50689B","#E5696F")) +
...
print(Figure_s1_1)
ggsave("Figure_s1_1.png", Figure_s1_1, width = 10, height = 8, dpi = 300)

#these results were used in the Figure S1 of the publication
...
# Visualization
Figure_s1_2 <- ggplot(summarized_data_reuse, aes(x = Type, y = Percentage, fill = as.factor(Reuse))) +
  geom_bar(stat = "identity", position = "stack") +
...
print(Figure_s1_2)
ggsave("Figure_s1_2.png", Figure_s1_2, width = 10, height = 8, dpi = 300)
...
# Visualization
Figure_s1_3 <- ggplot(summarized_data_Access, aes(x = Type, y = Percentage, fill = as.factor(Access))) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_manual(values = colors) +
...
print(Figure_s1_3)
ggsave("Figure_s1_3.png", Figure_s1_3, width = 10, height = 8, dpi = 300)
...
# Visualization
Figure_s1_4 <- ggplot(summarized_data_Licence, aes(x = Type, y = Percentage, fill = as.factor(Licence))) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_manual(values = colors) +
...
print(Figure_s1_4)
ggsave("Figure_s1_4.png", Figure_s1_4, width = 10, height = 8, dpi = 300)
...
```{r}
Figure_s1 <- Figure_s1_1 + Figure_s1_2 + Figure_s1_3 + Figure_s1_4 +
  plot_layout(
    ncol = 2, heights = c(10, 10), widths = c(10, 10)
  )
print(Figure_s1)
ggsave("Figure_s1.png", Figure_s1_4, width = 15, height = 10, units = "in")
...
#these results were used in the First result Paragraph of the publication
...
#these results were used in the sixth result Paragraph of the publication
...
#these results were used in the Figure 4 of the publication
...
Figure_S2 <- ggplot(proportion_data, aes(x = Year, y = Proportion, color = NewDAS, group = NewDAS)) +
  geom_line() +
  geom_point() +
...
ggsave("Figure_S2.png", Figure_S2, width = 8, height = 6,  bg = "white")

#these results were used in the Figure S2 of the publication
...
Figure_S3 <- ggplot(proportion_data, aes(x = Year, y = Proportion, color = Preprints, group = Preprints)) +
  geom_line() +
  geom_point() +
  geom_vline(xintercept = 2016, linetype = "dashed", color = "black") +
  geom_vline(xintercept = 2020, linetype = "dashed", color = "black") +
...
ggsave("Figure_S3.png", Figure_S3, width = 8, height = 6, bg = "white")

#these results were used in the Figure S3 of the publication
...
#these results were used in the seventh result paragraph and Table S3/S4 of the publication
...
#these results were used in the seventh result paragraph of the publication
...
Figure_3_1 <- ggplot(pred_probs_long, aes(x = Year, y = PredictedProbability, group = CompleteLevel, color = CompleteLevel)) + 
...
ggsave("Figure_3_1.png", Figure_3_1, width = 15, height = 10, units = "in",  bg = "white")

#these results were used in the Forth result paragraph and Figure 3 of the publication
...
# Modify ggplot command
Figure_3_2 <- ggplot(pred_probs_long, aes(x = Year, y = PredictedProbability, group = Reuselevel, color = Reuselevel)) + 
  geom_line(size = 2) +  # Set size of the lines to make them thicker
...
ggsave("Figure_3_2.png", Figure_3_2, width = 15, height = 10, units = "in",  bg = "white")
...
# Modify ggplot command
Figure_3_3 <- ggplot(pred_probs_long, aes(x = Year, y = PredictedProbability, group = AccessLevel, color = AccessLevel)) + 
  geom_line(size = 2) +  # Set size of the lines to make them thicker
  scale_color_manual(values = my_colors) +  # Use colors
  scale_x_continuous(breaks = unique(pred_probs_long$Year)) +  # Show all years on x-axis
...
ggsave("Figure_3_3.png", Figure_3_3, width = 15, height = 10, units = "in",  bg = "white")
...
# Modify ggplot command
Figure_3_4 <- ggplot(pred_probs_long, aes(x = Year, y = PredictedProbability, group = Licencelevel, color = Licencelevel)) + 
  geom_line(size = 2) +  # Set size of the lines to make them thicker
  scale_color_manual(values = my_colors) +  # Use colors
  scale_x_continuous(breaks = unique(pred_probs_long$Year)) +  # Show all years on x-axis
...
ggsave("Figure_3_4.png", Figure_3_4, width = 15, height = 10, units = "in",  bg = "white")
...
```
```{r}
Figure_3 <- Figure_3_1 + Figure_3_2 + Figure_3_3 + Figure_3_4 +
  plot_layout(
    ncol = 2, heights = c(10, 10), widths = c(10, 10)
  )
print(Figure_3)

ggsave("Figure_3.png", Figure_3, width = 15, height = 10, units = "in", bg="white")
...
#these results were used in the Fifth result paragraph and Table 2 of the publication
